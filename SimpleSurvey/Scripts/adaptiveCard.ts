...
function processMarkdown(text: string): any {
    return (<any>window).markdownit().render(text);
}
...
abstract class CardElement {
    ...
    shouldRemoveTopSpacingAfter(previousElement: CardElement) {
        return false;
    }
...
class ActionGroup extends CardElement {
    ...
    private _actionCardContainerPadding: any;
    private _actionCardContainerMargin: any;
...
class Container extends CardElement {
    ...
    style: ContainerStyle = ContainerStyle.Normal;
    startGroup: boolean = false;
    ...
    shouldRemoveTopSpacingAfter(previousElement: CardElement) {
        return previousElement != null &&
            ...
            (<Container>previousElement).style == ContainerStyle.Emphasis &&
    ...
    render(): HTMLElement {
        if (this.elementCount > 0) {
            ...
            let previousRenderedElement: HTMLElement = null;
